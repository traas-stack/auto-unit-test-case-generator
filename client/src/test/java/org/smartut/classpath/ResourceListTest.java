...
public class ResourceListTest {
	...
	public void testGetPackageName(){
		...
		Assert.assertEquals("bar.foo", ResourceList.getParentPackageName("bar.foo"));
	}
	...
	public void testHandleKnownJarFile(){
		...
		// we use one class among the jars SmartUt depends on
    ...
    @Test
	public void testLoadOfSmartUtTestClassesAsStream() throws IOException {
