...
public enum RuntimeVariable {
	...
	/** The total time SmartUt spent generating the test cases */
	Total_Time,
	...
	/** (FIXME: need to be implemented) The number of serialized objects that SmartUt is going to use for seeding strategies */
