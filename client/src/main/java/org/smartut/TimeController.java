...
/**
 * This class is used to keep track of how long SmartUt has spent
 * in each of its different phases (eg search, minimization, assertion generation).
 * 
 * 
 * <p>
 * TODO: in the long run, this should replace all the occurrences of time handling in SmartUt
 * 
 * @author arcuri
 *
 */
public class TimeController {
	 ...
	 * in milliseconds SmartUt was in that phase
	 */
	...
	public synchronized void updateState(ClientState newState) throws IllegalArgumentException{
		...
		if(!state.equals(ClientState.NOT_STARTED)){
			...
			//check if spent too much time, eg due to bug in SmartUt
