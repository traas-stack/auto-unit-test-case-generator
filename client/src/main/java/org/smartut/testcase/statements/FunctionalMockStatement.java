...
import org.smartut.runtime.FalsePositiveException;
...
public class FunctionalMockStatement extends EntityWithParametersStatement {
    ...
    public static boolean canBeFunctionalMockedIncludingSUT(Type type) {
        ...
        if (SmartUtMock.class.isAssignableFrom(rawClass) ||
                    ...
                    try {
                        ...
                        for (MethodDescriptor md : mockedMethods) {
                            ...
                            try {
                                ...
                                // FIXME: Happens for reasons I don't understand. By throwing a CodeUnderTestException SmartUt
                            ...
                            try {
                                ...
                                for (int i = 0; i < thenReturnInputs.length; i++) {
                                    ...
                                    if (k >= parameters.size()) {
                                        //throw new RuntimeException("SmartUt ERROR: index " + k + " out of " + parameters.size());
                                        throw new CodeUnderTestException(new FalsePositiveException("SmartUt ERROR: index " + k + " out of " + parameters.size()));
                                    }
