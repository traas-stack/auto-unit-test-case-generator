...
/**
 * Statements serve as the building blocks for test cases. Conceptually, a statement in SmartUt
 * test cases can be mapped to one or more statements in the Java language. Each statement in a test
 * case represents a value v of some type T. SmartUt distinguishes between different kinds of
...
public interface Statement {
	 ...
	 * 
	 * @param assertion
	 *            a {@link org.smartut.assertion.Assertion} object.
	 */
