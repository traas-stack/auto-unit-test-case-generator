...
public class ArrayStatement extends AbstractStatement {
	 ...
	 *            a {@link org.smartut.testcase.variable.ArrayReference} object.
	 */
	 ...
	 *
	 * @see
	 * org.smartut.testcase.Statement#getUniqueVariableReferences()
	 */
	/** {@inheritDoc} */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.smartut.testcase.StatementInterface#isValid()
	 */
	/** {@inheritDoc} */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.smartut.testcase.AbstractStatement#mutate(org.smartut.testcase.TestCase, org.smartut.testcase.AbstractTestFactory)
	 */
	/** {@inheritDoc} */
	@Override
			...
			for (VariableReference var : statement.getVariableReferences()) {
				if (var.getAdditionalVariableReference() == this.retval) {
					...
					if (!(currentVar instanceof ArrayIndex)) {
						LoggingUtils.getSmartUtLogger().error("Found assignment to array without ArrayIndex:");
						LoggingUtils.getSmartUtLogger().error(test.toCode());
						LoggingUtils.getSmartUtLogger().error(statement.getPosition() + ", "
						                                          + statement.getCode());
					}
					ArrayIndex index = (ArrayIndex) currentVar;
					maxAssignment = Math.max(maxAssignment, index.getArrayIndex());
