...
import org.smartut.runtime.ViolatedAssumptionAnswer;
import org.smartut.testcase.statements.*;
import org.smartut.testcase.statements.environment.EnvironmentDataStatement;
import org.smartut.testcase.variable.*;
import org.smartut.utils.*;
 ...
 * test case. This is the preferred way to produce executable code from SmartUt
 * tests.
 * 
...
public class TestCodeVisitor extends TestVisitor {
		...
		if (classNames.values().contains(name)) {
			...
			if(!fullName.equals(clazz.getCanonicalName())) {
				try {
					...
					// because that cannot happen in regular SmartUt use, only
					// from test cases
				}
			}
		}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.smartut.testcase.TestVisitor#visitTestCase(org.smartut.testcase.TestCase)
	 */
	/** {@inheritDoc} */
	@Override
	 ...
	 * 
	 * @param assertion
	 *            a {@link org.smartut.assertion.PrimitiveAssertion} object.
	 */
	 ...
	 * 
	 * @param assertion
	 *            a {@link org.smartut.assertion.PrimitiveFieldAssertion}
	 *            object.
	 */
	 ...
	 * 
	 * @param assertion
	 *            a {@link org.smartut.assertion.InspectorAssertion} object.
	 */
	 ...
	 * 
	 * @param assertion
	 *            a {@link org.smartut.assertion.NullAssertion} object.
	 */
	 ...
	 * 
	 * @param assertion
	 *            a {@link org.smartut.assertion.CompareAssertion} object.
	 */
	 ...
	 * 
	 * @param assertion
	 *            a {@link org.smartut.assertion.EqualsAssertion} object.
	 */
	 ...
	 * 
	 * @param assertion
	 *            a {@link org.smartut.assertion.SameAssertion} object.
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.smartut.testcase.TestVisitor#visitPrimitiveStatement(org.smartut.testcase.PrimitiveStatement)
	 */
	/** {@inheritDoc} */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.smartut.testcase.TestVisitor#visitFieldStatement(org.smartut.testcase.FieldStatement)
	 */
	/** {@inheritDoc} */
	@Override
...
//			result += parameter_string + " );"+NEWLINE;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.smartut.testcase.TestVisitor#visitMethodStatement(org.smartut.testcase.MethodStatement)
	 */
	/** {@inheritDoc} */
	@Override
	...
	public String generateCatchBlock(AbstractStatement statement, Throwable exception) {
		...
		if(sourceClass!=null && isValidSource(sourceClass) && isExceptionToAssertThrownBy(ex) && !Properties.NO_RUNTIME_DEPENDENCY) {
				/*
					do not check source if it comes from a non-runtime smartut
	...
	private boolean isValidSource(String sourceClass){
		return (! sourceClass.startsWith(PackageInfo.getSmartUtPackage()+".") ||
				sourceClass.startsWith(PackageInfo.getSmartUtPackage()+".runtime.")) &&
				...
				!sourceClass.startsWith("<smartut>");
	}
	...
	private Class<?> getExceptionClassToUse(Throwable exception){
        /*
          ...
          */
        Class<?> ex = exception.getClass();
        while (!Modifier.isPublic(ex.getModifiers()) || SmartUtMock.class.isAssignableFrom(ex) ||
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.smartut.testcase.TestVisitor#visitConstructorStatement(org.smartut.testcase.ConstructorStatement)
	 */
	/** {@inheritDoc} */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.smartut.testcase.TestVisitor#visitArrayStatement(org.smartut.testcase.ArrayStatement)
	 */
	/** {@inheritDoc} */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.smartut.testcase.TestVisitor#visitAssignmentStatement(org.smartut.testcase.AssignmentStatement)
	 */
	/** {@inheritDoc} */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.smartut.testcase.TestVisitor#visitNullStatement(org.smartut.testcase.NullStatement)
	 */
	/** {@inheritDoc} */
	@Override
