...
public class UtilsRMI {
	 ...
	 * 
	 * <p>
	 * So, if we start SmartUt with a connection on (eg WiFi), losing such connection
	 * would mess up SmartUt. Even worse, if SmartUt is started from Eclipse, Eclipse
