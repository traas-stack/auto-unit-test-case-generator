...
import org.smartut.runtime.testdata.EnvironmentDataList;
...
public class TestSuiteWriter implements Opcodes {
     ...
     * existing test.
     *
     * @param test a {@link org.smartut.testcase.TestCase} object.
    ...
    private String getEmptyTest() {
    	...
    	bd.append("// SmartUt did not generate any tests\n");
        bd.append(METHOD_SPACE);
        bd.append("}\n");
    	return bd.toString();
    }
    ...
    protected String getImports(List<ExecutionResult> results) {
        ...
        if (wasSecurityException) {
            //Add import info for SmartUt classes used in the generated test suite
    ...
    protected String getHeader(String test_name, String scaffolding_name, List<ExecutionResult> results) {
        ...
        builder.append("/*");
        builder.append(NEWLINE);
        builder.append(" * This file was automatically generated by SmartUt");
        builder.append(NEWLINE);
     ...
     * @param result a {@link org.smartut.testcase.execution.ExecutionResult} object.
