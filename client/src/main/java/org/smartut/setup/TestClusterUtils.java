...
public class TestClusterUtils {
	 ...
	 * @deprecated use {@code org.smartut.junit.CoverageAnalysis.isTest(Class<?> cls)}
	 *
	 * @param className
	 * @return
	 */
	...
	public static boolean isSmartUtClass(Class<?> c) {
        return c.getName().startsWith(PackageInfo.getSmartUtPackage());
