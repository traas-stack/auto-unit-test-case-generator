...
import org.smartut.rmi.service.MasterNodeRemote;
...
public class ClientProcess {
	...
	public void run() {
		...
		LoggingUtils.getSmartUtLogger().info("* " + getPrettyPrintIdentifier() + "Connecting to master process on port "
	...
	private void initializeToolJar() {
		 ...
		 * SmartUt, those will/should use the agent.
	...
	public static void main(String[] args) {
		...
		try {
			LoggingUtils.getSmartUtLogger().info("* Starting " + getIdentifier());
