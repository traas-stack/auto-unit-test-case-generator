...
import org.smartut.testcase.execution.MethodCall;
...
public abstract class DefUseExecutionTraceAnalyzer {
	...
	public static Set<DefUseCoverageTestFitness> getCoveredGoals(
		...
		/*
		 * ida@ubuntu:~/Bachelor/again/smartut/examples/ncs$ ^C
		 * ida@ubuntu:~/Bachelor/again/smartut/examples/ncs$ ../../SmartUt
		 ...
		 * smartut-tests/DEFUSE Time spent calculating single fitnesses:
		 * 540751ms Done!
		 */
		 ...
		 * to smartut-tests/DEFUSE Time spent calculating single fitnesses:
		 * 100324ms Done!
		 */
