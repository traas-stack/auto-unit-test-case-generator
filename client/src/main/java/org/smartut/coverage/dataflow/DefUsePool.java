...
//			LoggingUtils.getSmartUtLogger().info("registering LOCAL ARRAY VAR DEF "
//			                                         + d.toString());
...
//			LoggingUtils.getSmartUtLogger().info("Registered field method call as Definition "
//			                                         + d.toString());
...
//			LoggingUtils.getSmartUtLogger().info("Registered field method call as Use "
//			                                         + u.toString());
	 ...
	 * or some other part of smartut) will decide this using the complete CCFGs
...
//		if (d.isLocalArrayDefinition())
//			LoggingUtils.getSmartUtLogger().info("succesfully registered LOCAL ARRAY VAR DEF "
//			                                         + def.toString());
