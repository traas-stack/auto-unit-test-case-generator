 ...
 */
package org.smartut.coverage.dataflow.analysis;
...
import org.smartut.graphs.ccfg.CCFGCodeNode;
import org.smartut.graphs.ccfg.CCFGEdge;
import org.smartut.graphs.ccfg.CCFGFieldClassCallNode;
import org.smartut.graphs.ccfg.CCFGFrameNode;
import org.smartut.graphs.ccfg.CCFGMethodCallNode;
import org.smartut.graphs.ccfg.CCFGMethodEntryNode;
import org.smartut.graphs.ccfg.CCFGMethodExitNode;
import org.smartut.graphs.ccfg.CCFGMethodReturnNode;
import org.smartut.graphs.ccfg.CCFGNode;
import org.smartut.graphs.ccfg.ClassControlFlowGraph;
import org.smartut.graphs.ccfg.ClassControlFlowGraph.FrameNodeType;
import org.smartut.graphs.ccg.ClassCallNode;
...
public class AllUsesAnalysis {
	 ...
	 * 
	 * @param ccg
	 *            a {@link org.smartut.graphs.ccg.ClassCallGraph} object.
	 */
	...
	private Set<DefUseCoverageTestFitness> determineIntraInterMethodPairs(
		...
		LoggingUtils.getSmartUtLogger().debug("* Searching for pairs in " + methodEntry.getMethod()
				+ " ... ");
...
//		LoggingUtils.getSmartUtLogger().debug("  processing " + node.toString());
	...
	private void handleHandledNodesSet(CCFGNode node, Set<CCFGNode> handled) {
		if (handled.contains(node)){
			...
			LoggingUtils.getSmartUtLogger().info("We are in a recursive call. Skipping the node");
...
//		LoggingUtils.getSmartUtLogger().debug(
...
//		LoggingUtils.getSmartUtLogger().info("Processing Use for "+varName);
