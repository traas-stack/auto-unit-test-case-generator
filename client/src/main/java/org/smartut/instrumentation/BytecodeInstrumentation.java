...
import org.smartut.graphs.cfg.CFGClassAdapter;
import org.smartut.instrumentation.error.ErrorConditionClassAdapter;
import org.smartut.instrumentation.testability.BooleanTestabilityTransformation;
import org.smartut.instrumentation.testability.ComparisonTransformation;
import org.smartut.instrumentation.testability.ContainerTransformation;
import org.smartut.instrumentation.testability.StringTransformation;
import org.smartut.junit.writer.TestSuiteWriterUtils;
import org.smartut.runtime.RuntimeSettings;
import org.smartut.runtime.instrumentation.*;
import org.smartut.seeding.PrimitiveClassAdapter;
import org.smartut.setup.DependencyAnalysis;
import org.smartut.setup.TestCluster;
import org.smartut.testcarver.instrument.Instrumenter;
import org.smartut.testcarver.instrument.TransformerUtil;
import org.smartut.runtime.util.ComputeClassWriter;
...
public class BytecodeInstrumentation {
	...
	private static String[] getSmartUtPackages() {
		return new String[] { PackageInfo.getSmartUtPackage(), "org.exsyst", "de.unisb.cs.st.testcarver",
				"de.unisb.cs.st.smartut", "testing.generation.smartut", "de.unisl.cs.st.bugex" };
	}
	...
	/**
	 * Check if we the class belongs to an SmartUt package
	 *
	 * @param className
	 *            a {@link java.lang.String} object.
	 * @return a boolean.
	 */
	public static boolean checkIfSmartUtPackage(String className) {
		for (String s : BytecodeInstrumentation.getSmartUtPackages()) {
