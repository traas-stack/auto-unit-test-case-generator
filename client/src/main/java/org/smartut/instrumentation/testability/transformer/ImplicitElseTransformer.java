...
import org.smartut.graphs.cfg.BytecodeInstructionFactory;
...
import org.smartut.instrumentation.testability.DescriptorMapping;
...
public class ImplicitElseTransformer extends MethodNodeTransformer {
		...
		if (!hasAssignment) {
			...
			if (varNode.getOpcode() == Opcodes.PUTFIELD) {
				...
				MethodInsnNode storeOwner = new MethodInsnNode(
				        ...
				        "org/smartut/instrumentation/BooleanHelper",
	...
	/* (non-Javadoc)
	 * @see org.smartut.instrumentation.MethodNodeTransformer#transformFieldInsnNode(org.objectweb.asm.tree.MethodNode, org.objectweb.asm.tree.FieldInsnNode)
	 */
	@SuppressWarnings("unchecked")
	@Override
	...
	/* (non-Javadoc)
	 * @see org.smartut.instrumentation.MethodNodeTransformer#transformVarInsnNode(org.objectweb.asm.tree.MethodNode, org.objectweb.asm.tree.VarInsnNode)
	 */
	@Override
