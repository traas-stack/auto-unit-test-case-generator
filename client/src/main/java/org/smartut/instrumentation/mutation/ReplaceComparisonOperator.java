...
public class ReplaceComparisonOperator implements MutationOperator {
	...
	/* (non-Javadoc)
	 * @see org.smartut.cfg.instrumentation.MutationOperator#apply(org.objectweb.asm.tree.MethodNode, java.lang.String, java.lang.String, org.smartut.cfg.BytecodeInstruction)
	 */
	/** {@inheritDoc} */
	@Override
