...
public class InsertUnaryOperator implements MutationOperator {
	...
	/* (non-Javadoc)
	 * @see org.smartut.cfg.instrumentation.mutation.MutationOperator#apply(org.objectweb.asm.tree.MethodNode, java.lang.String, java.lang.String, org.smartut.cfg.BytecodeInstruction)
	 */
	/** {@inheritDoc} */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.smartut.cfg.instrumentation.mutation.MutationOperator#isApplicable(org.smartut.cfg.BytecodeInstruction)
	 */
	/** {@inheritDoc} */
	@Override
