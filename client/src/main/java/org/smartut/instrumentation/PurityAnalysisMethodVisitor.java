...
public class PurityAnalysisMethodVisitor extends MethodVisitor {
	...
	public void visitMethodInsn(int opcode, String owner, String name,
		...
		if (targetClassName.equals(org.smartut.runtime.Random.class.getCanonicalName()) || !BytecodeInstrumentation.checkIfSmartUtPackage(targetClassName)) {
			//Only ignore SmartUt callbacks
