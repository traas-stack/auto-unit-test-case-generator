...
import org.smartut.instrumentation.mutation.MutationOperator;
import org.smartut.instrumentation.mutation.ReplaceArithmeticOperator;
import org.smartut.instrumentation.mutation.ReplaceBitwiseOperator;
import org.smartut.instrumentation.mutation.ReplaceComparisonOperator;
...
import org.smartut.runtime.instrumentation.AnnotatedLabel;
...
public class MutationInstrumentation implements MethodInstrumentation {
	...
	/* (non-Javadoc)
	 * @see org.smartut.cfg.instrumentation.MethodInstrumentation#analyze(org.objectweb.asm.tree.MethodNode, java.lang.String, java.lang.String, int)
	 */
	/** {@inheritDoc} */
	...
	public void analyze(ClassLoader classLoader, MethodNode mn, String className,
		...
		while (j.hasNext()) {
			...
			for (BytecodeInstruction v : graph.vertexSet()) {
				...
				// If the bytecode is instrumented by SmartUt, then don't mutate
				if(v.isLabel()) {
	...
	/* (non-Javadoc)
	 * @see org.smartut.cfg.instrumentation.MethodInstrumentation#executeOnMainMethod()
	 */
	/** {@inheritDoc} */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.smartut.cfg.instrumentation.MethodInstrumentation#executeOnExcludedMethods()
	 */
	/** {@inheritDoc} */
	@Override
