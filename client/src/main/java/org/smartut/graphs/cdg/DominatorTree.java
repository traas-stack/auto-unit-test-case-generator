...
import org.smartut.graphs.cfg.ControlFlowGraph;
 ...
 * @author Andre Mis
 */
public class DominatorTree<V> extends SmartUtGraph<DominatorNode<V>, DefaultEdge> {
	 ...
	 *
	 * @param cfg a {@link org.smartut.graphs.cfg.ControlFlowGraph} object.
	 */
