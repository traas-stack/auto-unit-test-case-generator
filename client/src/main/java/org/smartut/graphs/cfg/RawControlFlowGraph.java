...
import org.smartut.coverage.dataflow.DefUseFactory;
import org.smartut.coverage.dataflow.Definition;
import org.smartut.coverage.dataflow.Use;
import org.smartut.graphs.GraphPool;
import org.smartut.utils.ReverseComparator;
...
public class RawControlFlowGraph extends ControlFlowGraph<BytecodeInstruction> {
	 ...
	 *            a boolean.
	 * @return a {@link org.smartut.graphs.cfg.ControlFlowEdge} object.
	 */
	 ...
	 * 
	 * @param targetDU
	 *            a {@link org.smartut.coverage.dataflow.DefUse} object.
	 * @param handle
