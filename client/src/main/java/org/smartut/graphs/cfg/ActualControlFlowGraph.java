 ...
 * 
 * 
 * cfg.SmartUtGraph is used as the underlying data structure holding the
...
public class ActualControlFlowGraph extends ControlFlowGraph<BasicBlock> {
	...
	public ActualControlFlowGraph computeReverseCFG() {
		// TODO: this must be possible to "pre implement" in SmartUtGraph for
		// all sub class of SmartUtGraph
	 ...
	 *            a {@link org.smartut.graphs.cfg.BasicBlock} object.
	 * @param origEdge
	 *            a {@link org.smartut.graphs.cfg.ControlFlowEdge} object.
	 */
