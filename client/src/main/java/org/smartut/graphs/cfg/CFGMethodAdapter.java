...
import org.smartut.runtime.instrumentation.AnnotatedMethodNode;
import org.smartut.instrumentation.coverage.BranchInstrumentation;
import org.smartut.instrumentation.coverage.DefUseInstrumentation;
import org.smartut.instrumentation.coverage.MethodInstrumentation;
import org.smartut.instrumentation.coverage.MutationInstrumentation;
...
public class CFGMethodAdapter extends MethodVisitor {
	...
	public AnnotationVisitor visitAnnotation(String desc, boolean visible) {
		if(Type.getDescriptor(SmartUtExclude.class).equals(desc)) {
			logger.info("Method has SmartUt annotation: "+desc);
			excludeMethod = true;
		}
