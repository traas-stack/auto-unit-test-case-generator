...
import org.smartut.ga.metaheuristics.TestSuiteAdapter;
...
public class MOSATestSuiteAdapter extends TestSuiteAdapter<AbstractMOSA> {
	 ...
	 * evolves {@link org.smartut.testsuite.TestChromosome} objects. Therefore, we must override
	 * those methods and create a {@link org.smartut.testsuite.TestSuiteChromosome} object with all
	 * the evolved {@link org.smartut.testsuite.TestChromosome} objects (either in the population or
     * in the {@link org.smartut.ga.archive.Archive}).
     *
     * The following code has been copied from org.smartut.ga.metaheuristics.mosa.AbstractMOSA
