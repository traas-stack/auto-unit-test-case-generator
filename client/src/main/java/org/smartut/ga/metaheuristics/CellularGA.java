...
import org.smartut.ga.Neighbourhood;
import org.smartut.ga.ReplacementFunction;
...
public class CellularGA<T extends Chromosome<T>> extends GeneticAlgorithm<T> {
	...
	public CellularGA (Properties.CGA_Models model, ChromosomeFactory<T> factory){
		...
		LoggingUtils.getSmartUtLogger().info("* Running the Cellular GA with the '" + Properties.MODEL + "' neighbourhoods model ");
	}
	 ...
	 *            a {@link org.smartut.ga.ReplacementFunction} object.
	 */
	 ...
	 * </p>
	 * 
	 * @return a {@link org.smartut.ga.ReplacementFunction} object.
	 */
