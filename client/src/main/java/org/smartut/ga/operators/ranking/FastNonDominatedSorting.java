 ...
 */
package org.smartut.ga.operators.ranking;
...
public class FastNonDominatedSorting<T extends Chromosome<T>> implements RankingFunction<T> {
	...
	/* (non-Javadoc)
	 * @see org.smartut.ga.metaheuristics.mosa.Ranking#getSubfront(int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.smartut.ga.metaheuristics.mosa.Ranking#getNumberOfSubfronts()
	 */
