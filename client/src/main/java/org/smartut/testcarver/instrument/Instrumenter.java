...
public final class Instrumenter
{
			...
			if(ins instanceof FieldInsnNode)
			{
				...
				if(opcode == Opcodes.GETFIELD || opcode == Opcodes.GETSTATIC ) 
				{
					...
					il.add(new MethodInsnNode(Opcodes.INVOKESTATIC,
							PackageInfo.getNameWithSlash(org.smartut.testcarver.capture.FieldRegistry.class),
							  "notifyReadAccess", 
	...
	private InsnList addCaptureCall(final boolean isStatic, final String internalClassName, final String methodName, final String methodDesc,final Type[] argTypes)
	{
		...
		il.add(new MethodInsnNode(Opcodes.INVOKESTATIC,
				PackageInfo.getNameWithSlash(org.smartut.testcarver.capture.Capturer.class),
								  "capture", 
			...
			if(insn instanceof MethodInsnNode) {
				...
				if(methodInsnNode.name.equals("<init>")) {
					...
					for(Class<?> wrapperClass : wrapperClasses) {
						if(wrapperClass.getName().equals(ownerName)) {
							...
							methodInsnNode.owner = "org/smartut/testcarver/wrapper/" + methodInsnNode.owner;
							break;
						}
					}
				} else {
					...
					for(Class<?> wrapperClass : wrapperClasses) {
						if(wrapperClass.getName().equals(ownerName)) {
							if(methodInsnNode.getOpcode() == Opcodes.INVOKESTATIC) {
								logger.debug("Replacing call "+methodInsnNode.name);
								methodInsnNode.owner = PackageInfo.getSmartUtPackageWithSlash()+"/testcarver/wrapper/" + methodInsnNode.owner;
							}
					...
					//						logger.debug("Replacing call "+methodInsnNode.name);
					//						methodInsnNode.owner = "org/smartut/testcarver/wrapper/java/util/Calendar";
				...
				for(Class<?> wrapperClass : wrapperClasses) {
					if(wrapperClass.getName().equals(name)) {
						...
						typeInsnNode.desc = PackageInfo.getSmartUtPackageWithSlash()+"/testcarver/wrapper/" + generatedType.getInternalName();
						break;
					}
				}
