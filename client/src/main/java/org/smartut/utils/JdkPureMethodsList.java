 ...
 * (For a definition of cheap-purity, refer to {@link org.smartut.assertion.CheapPurityAnalyzer
 * CheapPurityAnalyzer}.) For the sake of efficiency, the purity analysis has to be carried out
 * offline, i.e., prior to starting SmartUt, using some external tool. (Analyzing the entire JDK
 * anew every time SmartUt is launched would incur considerable overhead.) Instead, this class
