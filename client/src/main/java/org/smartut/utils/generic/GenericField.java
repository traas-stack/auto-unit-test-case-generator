...
public class GenericField extends GenericAccessibleObject<GenericField> {
	...
	/* (non-Javadoc)
	 * @see org.smartut.utils.GenericAccessibleObject#getAccessibleObject()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.smartut.utils.GenericAccessibleObject#getDeclaringClass()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.smartut.utils.GenericAccessibleObject#isField()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.smartut.utils.GenericAccessibleObject#isStatic()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.smartut.utils.GenericAccessibleObject#getName()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.smartut.utils.GenericAccessibleObject#toString()
	 */
	@Override
	...
	public void changeClassLoader(ClassLoader loader) {
		...
		try {
			...
			LoggingUtils.getSmartUtLogger().info("Class not found - keeping old class loader ",
			                                 e);
		} catch (SecurityException e) {
			LoggingUtils.getSmartUtLogger().info("Class not found - keeping old class loader ",
			                                 e);
		} catch (NoSuchFieldException e) {
			LoggingUtils.getSmartUtLogger().info("Field " + field.getName()
			                                         + " not found in class "
