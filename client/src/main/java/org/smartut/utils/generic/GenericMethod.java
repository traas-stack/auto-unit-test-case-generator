...
//			}
	...
	public void changeClassLoader(ClassLoader loader) {
		...
		try {
			...
			LoggingUtils.getSmartUtLogger().info("Method not found - keeping old class loader ");
		} catch (ClassNotFoundException e) {
			LoggingUtils.getSmartUtLogger().info("Class not found - keeping old class loader ", e);
		} catch (SecurityException e) {
			LoggingUtils.getSmartUtLogger().info("Class not found - keeping old class loader ",e);
		}
	}
