...
import org.smartut.runtime.vnet.NativeTcp;
import org.smartut.runtime.vnet.RemoteTcpServer;
...
public class NetworkHandling {
     ...
     * @return
     */
    public static boolean openRemoteTcpServer(SmartUtRemoteAddress remoteServer){
	 ...
	 */
	public static boolean sendDataOnTcp(SmartUtLocalAddress sutServer, byte[] data){
		if(sutServer==null){
			return false;
		}
     ...
     * @return
     */
    public static boolean sendMessageOnTcp(SmartUtLocalAddress sutServer, String message){
     ...
     * @return
     */
    public static boolean sendUdpPacket(SmartUtLocalAddress sutAddress, byte[] data){
        return sendUdpPacket(sutAddress, new SmartUtRemoteAddress(DEFAULT_REMOTE_ADDRESS, VirtualNetwork.getInstance().getNewRemoteEphemeralPort()),data);
    }
     ...
     * @return
     */
    public static boolean sendUdpPacket(SmartUtLocalAddress sutAddress, SmartUtRemoteAddress remoteAddress, byte[] data){
        if(sutAddress == null){
            return false;
        }
     ...
     * @return
     */
    public static boolean createRemoteTextFile(SmartUtURL url, String text){
        if(url == null){
            return false;
        }
