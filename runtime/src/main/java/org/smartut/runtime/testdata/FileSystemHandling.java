...
import org.smartut.runtime.vfs.FSObject;
import org.smartut.runtime.vfs.VFile;
...
public class FileSystemHandling {
	 ...
	 * @return
	 */
	public static boolean appendStringToFile(SmartUtFile file, String value){
	 ...
	 * @return
	 */
	public static boolean appendLineToFile(SmartUtFile file, String line){
	 ...
	 * @return
	 */
	public static boolean appendDataToFile(SmartUtFile file, byte[] data){
	...
	public static boolean createFolder(SmartUtFile file){
	 ...
	 * @return
	 */
	public static boolean setPermissions(SmartUtFile file, boolean isReadable, boolean isWritable, boolean isExecutable){
		if(file==null){
			return false;
		}
		FSObject target = VirtualFileSystem.getInstance().findFSObject(file.getPath());
	 ...
	 * @return
	 */
	public static boolean shouldThrowIOException(SmartUtFile file){
		if(file==null){
			return false;
		}
