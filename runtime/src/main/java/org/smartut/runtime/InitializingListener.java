 ...
 * <ul>
 * <li>
 * "manual" tests executed before SmartUt ones that
...
public class InitializingListener extends RunListener {
    ...
    /**
     * Property used for example in Ant to specify where the SmartUt tests have been compiled.
     */
    public static final String COMPILED_TESTS_FOLDER_PROPERTY = "SmartUtCompiledTestFolder";
        ...
        if (!scaffolding.exists()) {
            java.lang.System.out.println(
                    "WARN: scaffolding file not found. If this module has tests, recall to call the preparation step " +
                            ...
                            "'smartut:prepare' is called. See documentation at www.smartut.org for further details.");
            return list;
        }
