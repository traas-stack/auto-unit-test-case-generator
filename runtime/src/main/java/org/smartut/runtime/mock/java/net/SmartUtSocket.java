...
import org.smartut.runtime.vnet.VirtualNetwork.ConnectionType;
...
public class SmartUtSocket extends MockSocketImpl{
	...
	public SmartUtSocket(Proxy proxy) {
		this();
	...
	protected void accept(SocketImpl s) throws IOException {
		...
		if(!(s instanceof SmartUtSocket)) {
			throw new IOException("Can only handle mocked sockets");
		}

		SmartUtSocket mock = (SmartUtSocket) s;
