 ...
 */
package org.smartut.runtime.mock.java.lang;
...
public class MockThrowable extends Throwable  implements OverrideMock {
    ...
    public static StackTraceElement[] getDefaultStackTrace(){
        ...
        v[0] = new StackTraceElement("<smartut>", "<smartut>", "<smartut>", -1);
        v[1] = new StackTraceElement("<smartut>", "<smartut>", "<smartut>", -1);
        v[2] = new StackTraceElement("<smartut>", "<smartut>", "<smartut>", -1);
        return v;
    }

    public static StackTraceElement[] replacement_getStackTrace(Throwable source){
		if(!MockFramework.isEnabled() || source instanceof SmartUtMock){
