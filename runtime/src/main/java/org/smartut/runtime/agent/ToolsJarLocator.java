...
public class ToolsJarLocator {
	...
	/**
	 * Full name of a class in tools.jar that is used inside SmartUt
	 */
...
//		}
		...
		// Fix for when SmartUt is wrongly run with a JRE (eg on Windows if JAVA_HOME is not properly set in PATH)
