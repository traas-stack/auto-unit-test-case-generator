 ...
 * This class only handle the exchange of data between SUT and SmartUt tests, and not
...
public class NativeTcp {
	...
	/**
	 * The TCP buffer used by the SmartUt tests to simulate a remote connection
	 */
	...
	/**
	 * Info on remote (SmartUt tests) address/port
	 */
