...
public class ExcludedClasses {
    ...
    public static List<String> getPackagesShouldNotBeInstrumented() {
        ...
        list.add(PackageInfo.getSmartUtPackage());
        list.addAll(excludedClasses);

        //Note: be sure each package is ended with ".", otherwise you might ban more packages than you wanted

//        list.addAll(Arrays.asList(new String[]{"java.", "javax.", "sun.", PackageInfo.getSmartUtPackage(), "org.exsyst",
//                "de.unisb.cs.st.testcarver.", "de.unisb.cs.st.smartut.", "org.uispec4j.",
//                "de.unisb.cs.st.specmate.", "org.xml.", "org.w3c.",
//                "testing.generation.smartut.", "com.yourkit.", "com.vladium.emma.", "daikon.",
...
//                "dk.brics.automaton.", //used in DSE, and we have a class with that package inside SmartUt
...
//        }));
        ...
        if(RuntimeInstrumentation.getAvoidInstrumentingShadedClasses()){
            list.addAll(Arrays.asList(new String[]{
                     ...
                     * they are used by SmartUt. However, problems arise when running system tests before shading :(
