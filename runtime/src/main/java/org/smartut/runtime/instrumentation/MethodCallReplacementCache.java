...
public class MethodCallReplacementCache {
	...
	private MethodCallReplacementCache() {
		...
		if (RuntimeSettings.mockJVMNonDeterminism) {
			...
			addReplacementCall(new MethodCallReplacement("javax/swing/JComponent", "getPreferredSize",
					...
					PackageInfo.getNameWithSlash(org.smartut.runtime.mock.javax.swing.MockJComponent.class),
	...
	private void handleMockList() {
		for (Class<? extends SmartUtMock> mock : MockList.getList()) {
	...
	private void handleStaticReplacementMethods(Class<? extends SmartUtMock> mockClass) {
		...
		for (Method m : mockClass.getMethods()) {
			...
			if (!Modifier.isStatic(m.getModifiers())) {
				throw new RuntimeException("SmartUt Bug: improper annotations in class " + mockClass.getName());
			}
			...
			if (OverrideMock.class.isAssignableFrom(mockClass)) {
				...
				throw new RuntimeException("SmartUt Bug: StaticReplacementMethod can only be used in OverrideMock");
			}
	...
	private void addJavaLangCalls() {
		...
		addReplacementCall(new MethodCallReplacement("java/lang/System", "exit", "(I)V", Opcodes.INVOKESTATIC,
				PackageInfo.getNameWithSlash(org.smartut.runtime.System.class), "exit", "(I)V", false, false));
		addReplacementCall(new MethodCallReplacement("java/lang/System", "setSecurityManager", "(Ljava/lang/SecurityManager;)V", Opcodes.INVOKESTATIC,
				PackageInfo.getNameWithSlash(org.smartut.runtime.System.class), "setSecurityManager", "(Ljava/lang/SecurityManager;)V", false, false));
		addReplacementCall(new MethodCallReplacement("java/lang/System", "currentTimeMillis", "()J",
				Opcodes.INVOKESTATIC, PackageInfo.getNameWithSlash(org.smartut.runtime.System.class),
		...
		addReplacementCall(new MethodCallReplacement("java/lang/System", "nanoTime", "()J", Opcodes.INVOKESTATIC,
				PackageInfo.getNameWithSlash(org.smartut.runtime.System.class), "nanoTime", "()J", false, false));
		addReplacementCall(new MethodCallReplacement("java/lang/System", "identityHashCode", "(Ljava/lang/Object;)I",
				Opcodes.INVOKESTATIC, "org/smartut/runtime/System", "identityHashCode", "(Ljava/lang/Object;)I", false,
				false));
...
//				"(Ljava/lang/Object;)Ljava/lang/String;", false, false));
		...
		addReplacementCall(new MethodCallReplacement("java/lang/Class", "getClasses", "()[Ljava/lang/Class;",
				Opcodes.INVOKEVIRTUAL, PackageInfo.getNameWithSlash(org.smartut.runtime.Reflection.class),
		...
		addReplacementCall(new MethodCallReplacement("java/lang/Class", "getFields", "()[Ljava/lang/reflect/Field;",
				Opcodes.INVOKEVIRTUAL, PackageInfo.getNameWithSlash(org.smartut.runtime.Reflection.class), "getFields",
		...
		addReplacementCall(new MethodCallReplacement("java/lang/Class", "getDeclaredAnnotations",
				...
				PackageInfo.getNameWithSlash(org.smartut.runtime.Reflection.class), "getDeclaredAnnotations",
		...
		addReplacementCall(new MethodCallReplacement("java/lang/Class", "getDeclaredConstructors",
				...
				PackageInfo.getNameWithSlash(org.smartut.runtime.Reflection.class), "getDeclaredConstructors",
		...
		addReplacementCall(new MethodCallReplacement("java/lang/Class", "getModifiers", "()I", Opcodes.INVOKEVIRTUAL,
				PackageInfo.getNameWithSlash(org.smartut.runtime.Reflection.class), "getModifiers",
		 ...
		 * "org/smartut/runtime/ResourceLoader", "getResource",
