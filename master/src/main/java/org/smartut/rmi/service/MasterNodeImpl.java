...
public class MasterNodeImpl implements MasterNodeRemote, MasterNodeLocal {
	...
	@Override
	public void smartut_registerClientNode(String clientRmiIdentifier) throws RemoteException {
	...
	@Override
	public void smartut_informChangeOfStateInClient(String clientRmiIdentifier,
	...
	public void cancelAllClients() {
		for (ClientNodeRemote client : clients.values()) {
			try {
				LoggingUtils.getSmartUtLogger().info("Trying to kill client " + client);
	...
	@Override
	public void smartut_collectStatistics(String clientRmiIdentifier, Chromosome individual) {
		SearchStatistics.getInstance(clientRmiIdentifier).currentIndividual(individual);
	}

	@Override
	public void smartut_collectStatistics(String clientRmiIdentifier, RuntimeVariable variable, Object value)
	        throws RemoteException {
		SearchStatistics.getInstance(clientRmiIdentifier).setOutputVariable(variable, value);
	}

	@Override
	public void smartut_collectTestGenerationResult(
	...
	@Override
	public void smartut_flushStatisticsForClassChange(String clientRmiIdentifier)
			throws RemoteException {
		SearchStatistics.getInstance(clientRmiIdentifier).writeStatisticsForAnalysis();
	}

	@Override
	public void smartut_updateProperty(String clientRmiIdentifier, String propertyName, Object value)
    ...
    @Override
    public void smartut_migrate(String clientRmiIdentifier, Set<? extends Chromosome> migrants)
            throws RemoteException {
    ...
    @Override
    public void smartut_collectBestSolutions(String clientRmiIdentifier, Set<? extends Chromosome> solutions) {
        try {
