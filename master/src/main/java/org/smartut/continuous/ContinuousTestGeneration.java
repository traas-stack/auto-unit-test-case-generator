 ...
 * This can be called directly from SmartUt for
 ...
 * <ul>  
 * <li> No need to download SmartUt. This is done automatically
 * with Maven </li>
 ...
 * This will be useful to see how SmartUt is used in practice.
 * </p>
 * 
 * 
 * <p>
...
public class ContinuousTestGeneration {
	...
	public static boolean exportToFolder(String baseFolder, String exportFolder) throws IOException {
		...
		File smartutFolder = StorageManager.getBestTestFolder(basedir);

		File[] children = smartutFolder.listFiles();
		...
		FileIOUtils.copyDirectoryAndOverwriteFilesIfNeeded(smartutFolder,target);
		return true;
	}
