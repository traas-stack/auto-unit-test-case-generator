...
import org.smartut.instrumentation.testability.StringHelper;
...
public class RegexInstrumentationSystemTest extends SystemTestBase {
	...
	public void testTrivialForDynamicSeedingRegex() throws Throwable{
		...
		Assert.assertEquals(0.0, org.smartut.utils.RegexDistanceUtils.getDistanceTailoredForStringAVM(matching, TrivialForDynamicSeedingRegex.REGEX), 0.0);
		Assert.assertEquals(0.0, org.smartut.instrumentation.RegexDistance.getDistance(matching, TrivialForDynamicSeedingRegex.REGEX), 0.0);
