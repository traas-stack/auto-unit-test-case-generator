 ...
 */
package org.smartut.continuous.project;
...
import org.smartut.xsd.XSDUtils;
...
public class ProjectStaticDataTest {
  ...
  public void testIsToTest_LastestGenerationFailed() {
    ...
    // if SmartUt failed to generate a new test suite
  ...
  public void testIsToTest_SkippedClass() {
    ...
    g4.setTimeBudgetInSeconds(XSDUtils.convert(0)); // SmartUt skipped this one
