...
import org.smartut.intellij.util.EvoVersion;
...
public class SmartUtStartDialog extends JDialog {
    ...
    private JTextField smartutLocationTesxField;
    private JButton smartutSelectionButton;
    private JRadioButton mavenRadioButton;
    private JRadioButton smartutRadioButton;
    ...
    public void initFields(Project project, EvoParameters params) {
        ...
        smartutLocationTesxField.setText(params.getSmartUtJarLocation());
        ...
        if (params.usesMaven()) {
            ...
            smartutRadioButton.setSelected(true);
        }
        checkExecution();
    }


    public SmartUtStartDialog() {
        ...
        smartutRadioButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent actionEvent) {
                checkExecution();
            }
        });
        smartutSelectionButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent actionEvent) {
                onSelectSmartUt();
            }
    ...
    private void onSelectSmartUt() {
        ...
        fc.setFileFilter(new FileFilter() {
            ...
            public boolean accept(File file) {
                ...
                return checkIfValidSmartUtJar(file);
            }

            @Override
            public String getDescription() {
                return "SmartUt executable jar";
            }
        });
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            params.setSmartUtJarLocation(path);
            smartutLocationTesxField.setText(path);
        }
    }
    ...
    private void checkExecution() {
        ...
        } else if (smartutRadioButton.isSelected()) {
            params.setExecutionMode(EvoParameters.EXECUTION_MODE_JAR);
        }

        smartutLocationTesxField.setEnabled(smartutRadioButton.isSelected());
        smartutSelectionButton.setEnabled(smartutRadioButton.isSelected());
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            if (!checkIfValidJavaHome(new File(path))) {
                Messages.showMessageDialog(project, "Invalid JDK home: choose a correct one that contains bin/javac",
                        "SmartUt Plugin", Messages.getErrorIcon());
                return;
            }
    ...
    private boolean checkIfValidSmartUtJar(File file) {
        if (file == null || !file.exists() || file.isDirectory()) {
            return false;
        }
        ...
        return name.startsWith("smartut") && name.endsWith(".jar");
    }
...
// add your code here if necessary
    ...
    private boolean saveParameters(boolean validate) {
        ...
        String smartutJar = smartutLocationTesxField.getText();
        ...
        if (!params.usesMaven() && !checkIfValidSmartUtJar(new File(smartutJar))) {
            errors.add("Invalid SmartUt executable jar: choose a correct smartut*.jar one");
        } else {
            params.setSmartUtJarLocation(smartutJar);
        }
        ...
        if (validate && !errors.isEmpty()) {
            String title = "ERROR: SmartUt Plugin";
    ...
    public static void main(String[] args) {
        SmartUtStartDialog dialog = new SmartUtStartDialog();
        dialog.pack();
