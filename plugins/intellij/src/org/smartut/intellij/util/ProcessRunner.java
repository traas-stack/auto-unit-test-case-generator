...
import org.smartut.intellij.SmartUtParameters;
...
public class ProcessRunner {
    ...
    public static Process execute(Project project, AsyncGUINotifier notifier, SmartUtParameters params, File dir,
        ...
        if(params.usesMaven()){
            ...
            list = getSmartUtJarCommand(project, dir,params, classes,managerPort);
        }
        ...
        try {
            ...
            notifier.failed("Failed to execute SmartUt: "+e.getMessage());
            return null;
        }

    }

    private static List<String> getSmartUtJarCommand( Project project, File dir, EvoParameters params,
        ...
        list.add("-jar");
        list.add(params.getSmartUtJarLocation());
        ...
        String path = writeLineToFile("SmartUt_ctg_classpath_file", cp);
    ...
    private static String writeClassesToFile(Set<String> classes) {
        return writeLineToFile("SmartUt_ctg_CUT_file", getCommaList(classes));
    }
    ...
    @NotNull
    private static List<String> getMavenCommand(SmartUtParameters params, Set<String> classes, int port) {
        List<String> list = new ArrayList<>();
        list.add(params.getMvnLocation());
        list.add("compile");
        list.add("smartut:generate");
        ...
        list.add("smartut:export"); //note, here -Dctg_export_folder would do as well
