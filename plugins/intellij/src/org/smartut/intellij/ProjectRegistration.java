...
// the plugin.xml file, this method is called on IDEA start-up.
    ...
    public void projectOpened() {
        ...
        //create the tool window, which will appear in the bottom when an SmartUt run is started
        ToolWindowManager toolWindowManager = ToolWindowManager.getInstance(project);
        ToolWindow toolWindow = toolWindowManager.registerToolWindow("SmartUt", false, ToolWindowAnchor.BOTTOM);
        toolWindow.setTitle("SmartUt Console Output");
        ...
        IntelliJNotifier notifier = IntelliJNotifier.registerNotifier(project,"SmartUt Plugin", console);

        //create left-toolbar with stop button
        DefaultActionGroup buttonGroup = new DefaultActionGroup();
        buttonGroup.add(new StopSmartUtAction(notifier));
        ActionToolbar viewToolbar = am.createActionToolbar("SmartUt.ConsoleToolbar", buttonGroup, false);
