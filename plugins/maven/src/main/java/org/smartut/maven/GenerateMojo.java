...
import org.smartut.maven.util.FileUtils;
import org.smartut.maven.util.HistoryChanges;
...
public class GenerateMojo extends AbstractMojo {
	...
	public void execute() throws MojoExecutionException, MojoFailureException{
		...
		getLog().info("Going to generate tests with SmartUt");
		...
		runSmartUtOnSeparatedProcess(target, cp, basedir.getAbsolutePath());
	...
	private void runSmartUtOnSeparatedProcess(String target, String cp, String dir) throws MojoFailureException {
		...
		boolean ok = runner.runSmartUt(dir,params);
