...
import org.smartut.maven.util.ProjectUtils;
...
public class CoverageMojo extends AbstractMojo {
	...
	// JUnit test cases have to be converted to some format that SmartUt can understand
	...
	public void execute() throws MojoExecutionException, MojoFailureException {
		...
		getLog().info("Going to measure the coverage of manually written test cases with SmartUt");
		...
		SmartUtRunner runner = new SmartUtRunner(getLog(), this.artifacts, this.projectBuilder, this.repoSession);
		runner.registerShutDownHook();
		boolean ok = runner.runSmartUt(this.project.getBasedir().toString(), params);
