...
/**
 * <p>
 * When run, SmartUt generate tests in a specific folder.
 * New runs of SmartUt can exploit the tests in such folder, and/or modify them.
 * </p>
 *
 * <p>
 ...
 * If another folder is rather used (or if we want to run with Maven the tests in the default SmartUt folder),
