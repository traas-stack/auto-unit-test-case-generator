...
import org.smartut.jenkins.plot.CoveragePlot;
import org.smartut.jenkins.plot.TimePlot;
...
public class ProjectAction implements Action {
	...
	public String getIconFileName() {
		return "/plugin/smartut-jenkins-plugin/icons/smartut.png";
	}

	@Override
	public String getDisplayName() {
		return "SmartUt Project Statistics";
	}

	@Override
	public String getUrlName() {
		return "smartut-project";
	}
	...
	public void perform(AbstractMavenProject<?, ?> project, AbstractBuild<?, ?> build,
		...
		for (MavenModule module : prj.getModules()) {
		  ...
		  if (!fp.exists()) {
		    listener.getLogger().println(SmartUtRecorder.LOG_PREFIX + "There is not any " +
		  ...
		  listener.getLogger().println(SmartUtRecorder.LOG_PREFIX + "Analysing " +
