 ...
 */
package org.smartut.buildsupport;
...
/**
 * Make sure that tests generated by SmartUt can be run from different build tools.
...
public class BuildSupportIT {
    ...
    private String getSmartUtVersion(){
        //update version if run from IDE instead of Maven
        return System.getProperty("smartutVersion","1.0.5-SNAPSHOT");
    }
    ...
    public void testAnt() throws Exception{
        ...
        project.setUserProperty("smartutVersion",getSmartUtVersion());
    ...
    private Verifier getMaven(Path targetProject) throws Exception{
        ...
        props.put("smartutVersion", getSmartUtVersion());
