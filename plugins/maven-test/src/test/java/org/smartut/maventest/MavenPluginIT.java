...
public class MavenPluginIT {
    ...
    private final String srcEvo = "src/smartut";

    @Before
    @After
    public void clean() throws Exception{
        Verifier verifier  = getVerifier(projects);
        verifier.addCliOption("smartut:clean");
    ...
    public void testSimpleClass() throws Exception{
        ...
        Verifier verifier  = getVerifier(simple);
        verifier.addCliOption("smartut:generate");
        ...
        verifier.verifyTextInLog("Going to generate tests with SmartUt");
    ...
    public void testExportWithTests() throws Exception {
        ...
        Verifier verifier  = getVerifier(dependency);
        verifier.addCliOption("smartut:generate");
        verifier.addCliOption("smartut:export");
    ...
    private Path getESFolder(Path project){
        return project.resolve(".smartut");
    }
    ...
    private Verifier getVerifier(Path targetProject) throws Exception{
        ...
        props.put("smartutVersion", System.getProperty("smartutVersion","1.0.6-SNAPSHOT"));
