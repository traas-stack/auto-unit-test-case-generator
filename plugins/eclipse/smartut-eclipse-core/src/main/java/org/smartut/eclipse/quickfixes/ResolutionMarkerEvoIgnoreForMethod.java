...
public class ResolutionMarkerSmartUtIgnoreForMethod implements IMarkerResolution {

	@Override
	public String getLabel() {
		// TODO Auto-generated method stub
		return "Add @SmartUtIgnore annotation to method";
	}
...
//			TypeDeclaration td = (TypeDeclaration) compunit.types().get(0);
			...
			annotation.setTypeName(ast.newName("SmartUtIgnore"));
			ImportDeclaration id = ast.newImportDeclaration();
			
			id.setName(ast.newName("org.smartut.quickfixes.annotations.SmartUtIgnore"));
