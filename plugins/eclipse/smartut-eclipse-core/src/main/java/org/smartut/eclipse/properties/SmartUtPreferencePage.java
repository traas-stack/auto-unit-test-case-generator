...
public class SmartUtPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	static {
		PREFERENCE_STORE = new PreferenceStore("smartut-properties");
	}
	
	public SmartUtPreferencePage(){
	...
	protected void createFieldEditors() {
		...
		IntegerFieldEditor runtime = new IntegerFieldEditor(RUNTIME, "Time for SmartUt to improve code coverage (s)", getFieldEditorParent());
		...
		BooleanFieldEditor uncoveredLines = new BooleanFieldEditor(UNCOVERED_MARKER, "Show lines SmartUt couldn't cover", getFieldEditorParent());
