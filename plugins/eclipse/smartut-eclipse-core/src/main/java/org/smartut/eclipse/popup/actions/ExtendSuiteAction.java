...
import org.smartut.junit.DetermineSUT;
import org.smartut.junit.DetermineSUT.NoJUnitClassException;
...
//			MessageDialog.openError(shell, "SmartUt",
...
//	}
	...
	protected void addTestJob(final IResource target) {
		...
		try {
			...
			MessageDialog.openError(shell, "SmartUt", "Cannot find JUnit tests in " + suiteClass);
		}
