...
import org.smartut.runtime.mock.java.net.EvoURLStreamHandler;
import org.smartut.runtime.mock.java.net.URLUtil;
import org.junit.*;
...
public class InstrumentingAgent_IntTest {
	...
	public void testTransformationInClassExtendingAbstract() throws Exception{
		long expected = 42;
		org.smartut.runtime.System.setCurrentTimeMillis(expected);
		try{
